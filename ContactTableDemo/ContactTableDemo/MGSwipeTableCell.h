...
@property (strong, nonatomic) IBOutlet UILabel *lblCampaignName;
@property (strong, nonatomic) IBOutlet OBShapedButton *btnEntnoti;
@property (strong, nonatomic) IBOutlet OBShapedButton *btnResend;
@property (strong, nonatomic) IBOutlet OBShapedButton *btnPlay;
@property (strong, nonatomic) IBOutlet OBShapedButton *BtnTake;
@property (strong, nonatomic) IBOutlet OBShapedButton *BtnExpire;
@property (strong, nonatomic) IBOutlet UILabel *lblExpDate;

@property (strong, nonatomic) IBOutlet UILabel *lblName;
@property (strong, nonatomic) IBOutlet UILabel *lblTime;
@property (strong, nonatomic) IBOutlet UIImageView *imgProfile;
@property (strong, nonatomic) IBOutlet UIImageView *imgcontentbar;
